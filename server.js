...
// Registered transmitters are allowed to remain connected
// even when no audio packets are currently being sent.
const TRANSMITTER_IDLE_TIMEOUT_MS = 0;
...
const wss =
    new WebSocket.Server({
        ...
        // Prevent excessive incoming frame sizes.
        maxPayload:
            2 * 1024 * 1024
    ...
    (ws, req) => {
        ...
        ws.on(
            ...
            (message, isBinary) => {
                ...
                if (
                    ...
                    if (existingTransmitter) {
                        ...
                        console.log(
                            `[TX ${
                                station.toUpperCase()
                            }] Replacing existing active transmitter ${
                                activeCasterId
                            } with new connection ${
                                casterId
                            }`
                ...
                // ==================================================
                // ONLY BINARY AUDIO AFTER REGISTRATION
                // ==================================================
